...
public class KeyValueEntityV2 {
    ...
    public ColumnPropertyEntity getColumnPropertyEntity() {
        return columnPropertyEntity;
    }

    public void setColumnPropertyEntity(ColumnPropertyEntity columnPropertyEntity) {
        this.columnPropertyEntity = columnPropertyEntity;
    }
